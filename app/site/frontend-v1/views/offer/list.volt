...
<div class="hpanel">
    ...
    <form action="{{ url({'for': 'frontend-v1-offer-list'}) }}" method="get" class="form-inline">
    ...
    {{ partial("page", {'route': {'for': 'frontend-v1-offer-list'}, 'page': page, 'params_get': params_get, 'disable_arrow_force': true}) }}
