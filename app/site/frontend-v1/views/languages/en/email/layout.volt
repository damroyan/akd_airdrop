...
<head>
    ...
    <style media="all" type="text/css">
        ...
        .navbar{overflow:visible;margin-bottom:20px;color:#777;*position:relative;*z-index:2;width:650px;}
        ...
        .navbar-inverse .brand:hover,.navbar-inverse .nav>li>a:hover{color:#000}
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr>
        <td align="center">
            ...
            <table width="650" cellspacing="0" cellpadding="3" class="container">
                <tr class="navbar navbar-inverse">
                    <td><a class="brand pull-left" href="http://mywishboard.com/">Your project logo</a></td>
                    <td><ul class="nav pull-right"><li><a href="[YOUR LOGIN URL]"></a></li></ul></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <hr />
        ...
        <td bgcolor="#FFFFFF" align="center">
            ...
            <table width="650px" cellspacing="0" cellpadding="3" class="container">
                <tr>
                    <td>
                        <hr>
                        <p> Вы получили это письмо потому, что Вы выполнили подписку на сайте Your Site.
                            <br />
                            Вы всегда можете отказаться от подписки перейдя по этой
                            <a href="{{ url({'for': 'frontend-v1-token-index'}, {'action_token': unsubscribe}) }}">ссылке</a></p>
                    </td>
                </tr>
            </table>
            {% endif %}
